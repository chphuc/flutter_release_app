...
part 'account_information_store.g.dart';

class AccountInformationStore = _AccountInformationStore with _$AccountInformationStore;

abstract class _AccountInformationStore with Store {
  // constructor:---------------------------------------------------------------
  _AccountInformationStore(this._getUserInformationUseCase, this.errorStore);
