...
mixin _$UserInformationStore on _UserInformationStore, Store {
  Computed<bool>? _$loadingComputed;

  @override
  bool get loading => (_$loadingComputed ??= Computed<bool>(() => super.loading,
          name: '_UserInformationStore.loading'))
      .value;

  late final _$fetchUserInformationsFutureAtom = Atom(
      name: '_UserInformationStore.fetchUserInformationsFuture',
      context: context);
  ...
  late final _$userInformationAtom =
      Atom(name: '_UserInformationStore.userInformation', context: context);
  ...
  late final _$getUserInformationAsyncAction =
      AsyncAction('_UserInformationStore.getUserInformation', context: context);
